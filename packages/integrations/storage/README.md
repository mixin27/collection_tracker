...
A simple and secure local storage package for flutter app with support for primitives, collections, JSON serialization, and secure data storage.
...
✅ **Export/Import Service** - Export and import data service
...
```dart
final storage = PrefsStorageService.instance;
